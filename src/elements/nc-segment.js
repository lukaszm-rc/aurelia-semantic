...
import {customElement, computedFrom, bindable, containerless, inject, LogManager} from 'aurelia-framework';

@inject(Element)
@customElement('nc-segment')
@containerless()
export class NcSegment {
    ...
    constructor(element) {
        this.logger = LogManager.getLogger('nc-segment-element');
